...

{
  ...
  #
  # `process.env.FOO ?? "fallback"` is valid in the Next build but `process` is
  # undefined in a plain browser, which would throw before any data was read.
  # The static build takes the fallback.
